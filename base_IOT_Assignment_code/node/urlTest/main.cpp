...
#include <string>
#include <stdlib.h>
#include <winsock.h>//dont forget to add wsock32.lib to linker dependencies file is libwsock32.a
#include <sstream>
...
{
    string sensorData = "10,5,15,11,15,12,20,15,"; // 10,15,15,20 are temperature values and 5,11,12,15 are time values
    string request;
    string response;
    int resp_leng;
